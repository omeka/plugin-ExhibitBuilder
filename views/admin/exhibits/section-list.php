    ...
    <?php foreach($exhibit->Sections as $key => $exhibitSection ): ?>
        <li id="section_<?php echo html_escape($exhibitSection->id); ?>" class="exhibit-section-item">
            <div class="section-info">
                    <span class="input"><?php echo $this->formText("Sections[$key][order]", $exhibitSection->order, array('size'=>2,'class'=>'order-input', 'id' => 'section-' . $exhibitSection->id . '-order')  ); ?></span>
