...
add_plugin_hook('items_browse_sql', 'exhibit_builder_item_browse_sql');
add_plugin_hook('admin_items_search', 'exhibit_builder_append_to_advanced_search');
add_plugin_hook('public_items_search', 'exhibit_builder_append_to_advanced_search');
