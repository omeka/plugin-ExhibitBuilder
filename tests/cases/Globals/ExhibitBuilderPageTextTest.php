 ...
 */
class ExhibitBuilderPageTextTest extends ExhibitBuilder_TestCase 
{
    /**
    ...
    public function testExhibitBuilderPageTextWhenExhibitPageIsSpecified() 
    {
        ...
        for($i = 1; $i <= $maxExhibitPageEntries; $i++) {
            $exhibitPageEntry = $this->_createNewExhibitPageEntry($exhibitPage, 'Exhibit Page Entry '.$i, $i, null);
